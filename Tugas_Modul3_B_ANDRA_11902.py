...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1902</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    if os.path.exists(model_path):
        ...
        ing4 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.2", 70.0, 99.0)
        ...
        input_data = [mtk1, mtk2, mtk3, mtk4, ing1, ing2, ing3, ing4, ind1, ind2, ind3, ind4,
                      kkm_mtk1, kkm_mtk2, kkm_mtk3, kkm_mtk4, kkm_ind1, kkm_ind2, kkm_ind3, kkm_ind4,
